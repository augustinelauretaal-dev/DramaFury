# 🎬 DramaFury — K-Drama Streaming Platform
...
NEXT_PUBLIC_SITE_NAME=DramaFury
...
DramaFury includes a built-in REST API at `/api/stream` that returns all available embed sources for any TMDB title.
...
| `NEXT_PUBLIC_SITE_NAME`     | ❌ No     | Site display name (default: `DramaFury`)           |
