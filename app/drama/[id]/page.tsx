  ...
  if (loading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-4">
        ...
        <p className="text-gray-500 text-sm">Loading drama details...</p>
      </div>
    );
  }
        ...
        <div className="flex flex-col md:flex-row gap-6 md:gap-8">
          ...
          <div className="flex-1 pt-2 md:pt-6">
            ...
            {drama.original_name && drama.original_name !== drama.name && (
              <p className="text-gray-500 text-sm mb-2">{drama.original_name}</p>
            )}
              ...
              <div className="flex items-center gap-2 mb-4 text-xs text-gray-500">
                ...
                {drama.networks.slice(0, 2).map((n, i) => (
                  <span key={n.id} className="text-gray-400">
                    {n.name}{i < Math.min(drama.networks.length, 2) - 1 ? ',' : ''}
                  </span>
                ))}
              </div>
            )}
