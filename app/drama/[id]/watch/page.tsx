...
export default function WatchPage() {
  ...
  }, [id, season, episode, drama, router]);

  useEffect(() => {
    fetchDrama();
  }, [fetchDrama]);

  /* ── Validate on season/episode change ── */
  useEffect(() => {
    if (id) {
      validateEpisode();
    }
  }, [id, season, episode, validateEpisode]);

  /* ── Handle episode selection from EpisodeList ── */
  ...
  /* ── Navigate to next/previous with validation ── */
  ...
  }, [episode, season, getMaxEpisodeForSeason, handleEpisodeSelect]);
    ...
    <div className="max-w-[1400px] mx-auto px-4 py-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          {/* Validation Warning */}
          {!validation.valid && !validation.validating && validation.error && (
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
            ...
            {/* Prev / Next episode buttons with smart navigation */}
          ...
          {drama && (
            <div className="flex flex-wrap items-center gap-3 text-xs text-gray-500">
              ...
              {drama.first_air_date && (
                <span>{drama.first_air_date.slice(0, 4)}</span>
              )}
