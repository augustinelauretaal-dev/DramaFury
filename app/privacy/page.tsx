    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="mb-10">
        ...
        <p className="text-sm text-gray-400 leading-relaxed max-w-3xl">
          DramaFury (&ldquo;we&rdquo;, &ldquo;us&rdquo;, or &ldquo;our&rdquo;) is committed to protecting your privacy. This Privacy
          Policy explains what information we collect, how we use it, and the choices you have
          regarding your information when you visit and use DramaFury (the &ldquo;Service&rdquo;). Please read
      ...
      <Section title="Introduction">
        <p>
          DramaFury is a free K-drama and Asian drama streaming index that aggregates publicly
        ...
        <p>
          This policy applies to all visitors and registered users of DramaFury, regardless of
          how you access the Service — whether via desktop browser, mobile browser, or any
          other means. By using DramaFury, you consent to the data practices described in this
      ...
      <Section title="Information We Collect">
        ...
        <p>
          ...
          When you visit DramaFury, certain technical information is automatically collected,
      ...
      <Section title="How We Use Your Information">
        ...
        <ul className="list-disc list-inside space-y-2 pl-2 marker:text-primary">
          <li>To provide, operate, and maintain the DramaFury Service</li>
      ...
      <Section title="Third-Party Services">
        <p>
          DramaFury relies on several third-party services to function. Each of these parties
        ...
        <ul className="list-disc list-inside space-y-2 pl-2 marker:text-primary">
          ...
          <li>
            ...
            your IP address and viewing activity. DramaFury is not responsible for those data
            practices.
          </li>
          <li>
      ...
      <Section title="Cookies">
        <p>
          ...
          information about your visit. DramaFury uses the following types of cookies:
        </p>
        <ul className="list-disc list-inside space-y-2 pl-2 marker:text-primary">
          <li>
      ...
      <Section title="Data Security">
        ...
        <p>
          ...
          We recommend using a strong, unique password for your DramaFury account and enabling
      ...
      <Section title="Children's Privacy">
        <p>
          DramaFury is not directed to, and is not intended for use by, children under the age
      ...
      <Section title="Changes to This Policy">
        ...
        <p>
          ...
          periodically to stay informed. Your continued use of DramaFury after any changes
