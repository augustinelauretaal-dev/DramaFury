    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="mb-10">
        ...
        <p className="text-gray-400 text-sm mt-3 leading-relaxed">
          Please read these Terms of Service carefully before using DramaFury. By accessing or using
      ...
      <Section title="Acceptance of Terms">
        <p>
          By accessing or using DramaFury (&quot;the Service&quot;, &quot;we&quot;, &quot;us&quot;,
        ...
        <p>
          These Terms of Service constitute the entire agreement between you and DramaFury regarding
      ...
      <Section title="Description of Service">
        <p>
          DramaFury is a free streaming index that aggregates publicly available embed links to
        ...
        <p>
          DramaFury acts solely as a directory and index service. We do not produce, upload, host, or
      ...
      <Section title="Educational & Personal Use">
        <p>
          DramaFury is provided for educational and personal, non-commercial use only. The Service is
        ...
        <p>By using DramaFury, you agree that you will:</p>
        <ul className="list-disc list-inside space-y-1 pl-2">
      ...
      <Section title="Intellectual Property">
        <p>
          DramaFury respects intellectual property rights and expects users to do the same. The
        ...
        <p>
          ...
          broadcasting networks. DramaFury does not claim any ownership of video content. We do not
          host, store, upload, or distribute any video files whatsoever.
        </p>
        <p>
          <strong className="text-gray-300">DramaFury branding:</strong> The DramaFury name, logo, and
        ...
        <p>
          ...
          to DramaFury (such as comments or reviews, if applicable) remains your property, but you
      ...
      <Section title="Prohibited Activities">
        ...
        <ul className="list-disc list-inside space-y-1 pl-2">
          ...
          <li>
            Scraping, crawling, harvesting, or otherwise collecting data from DramaFury in bulk
          ...
          <li>
            ...
            access or integrating DramaFury content into commercial products
          </li>
          <li>
          ...
          <li>
            Attempting to gain unauthorized access to other user accounts or to DramaFury&apos;s
            backend systems
          </li>
          <li>
            Systematically mirroring or archiving the DramaFury website or any portion of its content
          </li>
        </ul>
        <p>
      ...
      <Section title="Disclaimer of Warranties">
        <p>
          ...
          PERMITTED BY APPLICABLE LAW, DRAMAFURY EXPRESSLY DISCLAIMS ALL WARRANTIES, INCLUDING BUT
          NOT LIMITED TO:
        </p>
        <ul className="list-disc list-inside space-y-1 pl-2">
          <li>
        ...
        <p>
          DramaFury does not endorse, verify, or take responsibility for the quality, legality, or
      ...
      <Section title="Limitation of Liability">
        <p>
          TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, DRAMAFURY AND ITS OPERATORS, DIRECTORS,
        ...
        <p>
          In no event shall DramaFury&apos;s total liability to you for all claims relating to the
          ...
          whether DramaFury has been advised of the possibility of such damages.
        </p>
      </Section>

      <Section title="DMCA & Copyright">
        <p>
          DramaFury respects the intellectual property rights of copyright holders and complies with
        ...
        <p>
          ...
          through DramaFury infringes your copyright, please note that DramaFury does not host any
        ...
        <p>
          To submit a DMCA notice to DramaFury for removal of links from our index, please visit our{' '}
      ...
      <Section title="Termination">
        ...
        <ul className="list-disc list-inside space-y-1 pl-2">
          ...
          <li>Conduct that we believe is harmful to other users, third parties, or DramaFury</li>
