...
export const metadata: Metadata = {
  title: 'Request Drama',
  description:
    'Request a drama, report a broken video, or report a bug on DramaFury. We review all requests and aim to add content within 48 hours.',
};
    ...
    <div className="min-h-screen">
      <div className="max-w-5xl mx-auto px-4 py-10 sm:py-16 animate-fade-in">
        ...
        >
          ...
          <span className="text-gray-300">Request Drama</span>
        </nav>
        ...
        <div className="mb-10">
          ...
          <h1 className="text-3xl sm:text-4xl font-black text-white mb-3 leading-tight tracking-tight">
            Request a <span className="gradient-text">Drama</span>
          </h1>
          ...
          <aside className="space-y-4 lg:sticky lg:top-20">
            ...
            <div className="bg-[#1a1a1a] border border-primary/10 rounded-xl p-5 bg-gradient-to-br from-primary/5 to-transparent">
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                ...
                player — we have{' '}
                <span className="text-white font-semibold">10 servers</span>{' '}
                available!
              </p>
            </div>
