...
export const metadata: Metadata = {
  title: 'FAQ',
  description:
    'Find answers to common questions about DramaFury — streaming, subtitles, video quality, content requests, and more.',
};
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 sm:py-16 animate-fade-in">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 text-base sm:text-lg max-w-xl mx-auto leading-relaxed">
            ...
            questions about DramaFury — streaming, servers, content, and more.
          </p>
        </div>
