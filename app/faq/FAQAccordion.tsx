...
const FAQ_DATA: FAQItem[] = [
  // ── Getting Started ──────────────────────────────────────────────────────
  {
    ...
    question: 'Is DramaFury free to use?',
    answer:
      'Yes! DramaFury is completely free. No subscription, no credit card required. Simply visit the site and start watching your favourite K-dramas instantly.',
  },
  {
    category: 'Getting Started',
  ...
  },
  {
    ...
    answer:
      'DramaFury works on any device with a modern web browser — desktop, laptop, tablet, or smartphone. No app download needed.',
  },
  ...
  },
  {
    ...
    answer:
      'Downloading is not supported on DramaFury. This is a browser-based streaming platform.',
  },
