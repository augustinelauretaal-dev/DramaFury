...
//   title: 'DMCA Policy',
//   description: 'DramaFury DMCA takedown policy and copyright notice submission.',
// };
      ...
      <div className="lg:grid lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="lg:col-span-2">
          ...
          <p className="text-gray-400 text-sm leading-relaxed mb-8 max-w-2xl">
            DramaFury respects intellectual property rights and complies with the Digital Millennium
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400 leading-relaxed mb-3">
                  DramaFury does not store or host any video files. All video content is sourced from
          ...
          <div className="mb-8">
            ...
            <ol className="space-y-3">
              {[
                ...
                'The specific URL(s) on DramaFury where the allegedly infringing content appears.',
          ...
          <div className="bg-[#1a1a1a] border border-white/5 rounded-2xl p-6">
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  <label className="block text-xs font-medium text-gray-400 mb-1.5">
                    Infringing URL on DramaFury <span className="text-primary">*</span>
                  </label>
                  <input
                    type="url"
                    name="infringingUrl"
                    ...
                    onChange={handleChange}
                    placeholder="https://dramafury.com/drama/..."
                    required
                    className={inputClass}
                  />
                  <p className="text-xs text-gray-600 mt-1.5 pl-1">
                    Paste the full DramaFury page URL where the infringing content appears.
                  </p>
                </div>
        ...
        <div className="lg:col-span-1 mt-8 lg:mt-0">
          <div className="lg:sticky lg:top-20 space-y-4">
            ...
            <p className="text-xs text-gray-600 leading-relaxed px-1">
              Repeat infringers will have their access to DramaFury terminated in appropriate
