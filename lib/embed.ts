...
const PROVIDERS: ProviderConfig[] = [
  ...
  // ── Tier 3: Additional Backup Providers ───────────────────────────────────────
  {
    id: 'filmku',
    name: 'FilmKu',
    badge: 'SUB',
  ...
  // ── Tier 4: Additional Working Providers ────────────────────────────────────
  {
    id: 'vidlink',
    name: 'VidLink',
    badge: 'HD',
    ...
    hasSubs: true,
    priority: 30,
    tv: (id, s, ep) => `https://vidlink.pro/embed/tv/${id}/${s}/${ep}?language=en`,
    movie: (id) => `https://vidlink.pro/embed/movie/${id}?language=en`,
  },
  {
    id: '111movies',
    name: '111Movies',
    ...
    hasSubs: true,
    priority: 31,
    tv: (id, s, ep) => `https://111movies.com/embed/tv/${id}?s=${s}&e=${ep}`,
  ...
  },
  {
    ...
    hasSubs: true,
    priority: 32,
    tv: (id, s, ep) => `https://flicky.host/embed/tv/${id}?s=${s}&e=${ep}`,
    movie: (id) => `https://flicky.host/embed/movie/${id}`,
  },
];
